...
The spruce budworm ATM was initiated by the United States Forest Service Research Branch in 2003 by Gary Achtemeier, after consultations with Brian Sturtevant. The early ATM was grounded in Gary's foundational work on particle dispersal through the 1970s-2000s [@scott1987; @achtemeier1998; @achtemeier2002].

Following a materials transfer in 2013, the Canadian Forest Service (CFS) and University of Wisconsin (UW) assumed lead roles in model development, with CFS implementing an operationalized version of the model in BioSIM, and UW implementing a research and develepment version in Python. The operational version simulates thousands of flight tracks and is useful as a strategic policy  and planning tool. The experimental version simulates millions of flight tracks and is designed as a tactical pest management planning tool. Both are "operational" from an informatic perspectives.
