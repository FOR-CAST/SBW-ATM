...
The SBW transport model (ATM) is an individual-based (or agent-based) modeling framework designed to simulate and understand the long-distance dispersal of adult SBW moths.
